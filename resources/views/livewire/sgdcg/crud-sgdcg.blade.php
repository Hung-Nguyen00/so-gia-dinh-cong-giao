                ...
                <div class="btn-group ml-3 pb-1">
                    ...
                    <ul class="dropdown-menu p-2 w-100">
                        ...
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox" @click="chu_ho = !chu_ho" checked class="custom-control-input" id="customSwitch2">
                            <label class="custom-control-label" for="customSwitch2">Chủ hộ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox"  @click="giao_ho = !giao_ho" class="custom-control-input" id="customSwitch3">
                            <label class="custom-control-label" for="customSwitch3">Giáo họ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox"  @click="chuyen_nhap_xu = !chuyen_nhap_xu" class="custom-control-input" id="customSwitch4">
                            <label class="custom-control-label" for="customSwitch4">Chuyển nhập xứ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox"  @click="ngay_lap_so = !ngay_lap_so" class="custom-control-input" id="customSwitch5">
