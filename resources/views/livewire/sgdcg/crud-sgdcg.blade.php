        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="btn-group ml-3 pb-1">
                    <a class="btn btn-sm btn-outline-primary" style="border-radius: 4px;" data-toggle="dropdown"
                       href="#">
                        Chọn kiểu lọc
                    ...
                    <ul class="dropdown-menu p-2 w-100">
                        ...
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox" @click="chu_ho = !chu_ho" checked class="custom-control-input"
                                   id="customSwitch2">
                            <label class="custom-control-label" for="customSwitch2">Chủ hộ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox" @click="giao_ho = !giao_ho" class="custom-control-input"
                                   id="customSwitch3">
                            <label class="custom-control-label" for="customSwitch3">Giáo họ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox" @click="chuyen_nhap_xu = !chuyen_nhap_xu"
                                   class="custom-control-input" id="customSwitch4">
                            <label class="custom-control-label" for="customSwitch4">Chuyển nhập xứ</label>
                        </div>
                        <div class="custom-control custom-switch mt-1">
                            <input type="checkbox" @click="ngay_lap_so = !ngay_lap_so" class="custom-control-input"
                                   id="customSwitch5">
                            <label class="custom-control-label" for="customSwitch5">Ngày lập sổ</label>
                        </div>
                    </ul>
                </div>
                ...
                <div class="d-flex flex-wrap pt-1">
                    @if(\Auth::user()->quanTri->ten_quyen == 'admin')
                        <div class="col-md-3">
                            ...
                            <select data-live-search="true" class="selectpicker  select form-control"
                                    wire:model="gx_id_search">
                    ...
                    @endif
                    <div x-show="ten_thanh" x-transition class="form-group col-md-3">
                        <label>
                            Tên thánh
                        </label>
                    ...
                    <div x-show="chu_ho" x-transition class="form-group col-md-3">
                        <label for="">Chủ hộ</label>
                        <input type="text" wire:model.lazy="ten_chu_ho" class="form-control">
                    </div>
                    <div x-show="giao_ho" x-transition class="form-group col-md-3 ">
                    ...
                    <div x-show="chuyen_nhap_xu" x-transition class="form-group col-md-3">
                        <label>
                    ...
                    <div x-show="ngay_lap_so" x-transition class="form-group col-md-6">
                        ...
                        @foreach($all_so_gia_dinh as $g)
                            <tr>
                                ...
                                <td class="text-center">{{ $g->thanh_vien_so2_count > 0 ? $g->thanh_vien_so2_count : $g->thanh_vien_count }}
                                    <a href="{{ route('so-gia-dinh.show', $g)  }}"> <i
                                                style="font-size: 20px; color: blue" class="la la-eye"></i></a>
                                <td>
                                    @if($g->giaoXu)
