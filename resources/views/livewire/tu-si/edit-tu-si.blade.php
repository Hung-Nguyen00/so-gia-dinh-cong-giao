<div>
        ...
        <div class="row">
            <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                <div class="form-group">
                    <div>
                        ...
                        <select class="select  form-control pt-2" value="{{ old('ten_thanh_id')}}"
                                wire:model="ten_thanh_id" data-live-search="true">
            ...
            <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                <div class="form-group ">
                    <div>
                        ...
                        <select class="select  form-control pt-2" value="{{ old('chuc_vu_id') }}"
                                wire:model="chuc_vu_id" data-live-search="true">
            ...
            <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"
                           value="{{ old('dia_chi_hien_tai') ?? $tu_si->dia_chi_hien_tai }} "
                        ...
                        <select class="select form-control pt-2"
                            ...
                            @foreach($all_giao_phan as $cv)
                                @if($cv->id === $tu_si->giao_phan_id)
                                    <option selected value="{{ $cv->id }}"> {{ $cv->ten_giao_phan }} - Giáo
                                        tỉnh: {{ $cv->giaoTinh->ten_giao_tinh }} </option>
                                @else
                                    <option {{ old('giao_phan_id') == $cv->id ? 'selected' : '' }}   value="{{ $cv->id }}"> {{ $cv->ten_giao_phan }}
                                        - Giáo tỉnh: {{ $cv->giaoTinh->ten_giao_tinh }}</option>
                                @endif
                            @endforeach
                        </select>
                    </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-6 mt-3">
                <div class="d-flex">
                    ...
                    <button type="button" wire:click.prevent="endNhiemSo()" class="btn btn-info mr-2">Kết thúc nhiệm sở
                        cũ
                    </button>
                    <button type="button" wire:click.prevent="startNhiemSo()" class="btn btn-info mr-2">Chuyển nhiệm sở
                        mới
                    </button>
                </div>
            </div>
    ...
    <form action="{{ route('tu-si.destroy', $tu_si) }}" style="margin-top: -36px;" method="POST">
        ...
        <button type="submit"
                ...
                class="btn btn-outline-danger d-inline-block px-3 float-right">Xóa tu sĩ
        </button>
    </form>
</div>
