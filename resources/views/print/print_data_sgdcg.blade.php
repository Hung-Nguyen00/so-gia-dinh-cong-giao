        ...
        <div class="col-lg-6">
            <div class="row tab-content">
                <div class="pl-3">
                    ...
                    <div class="mt--3">
                        <p>Tên thánh, họ, gọi: {{ $thanh_vien_cha->ten_thanh . ' ' . $thanh_vien_cha->ho_va_ten }}</p>
                        ...
                        @foreach($info_cha_me_cha as $info)
                            @if($info->chuc_vu_gd == 'Cha')
                                <p>Con ông: {{ $info->ten_thanh .' '. $info->ho_va_ten }} </p>
                            @else
                                <p>Và bà: {{ $info->ten_thanh .' '. $info->ho_va_ten }}</p>
                            @endif
                        @endforeach
                        @if($gx_gp_cha)
                            <p>Thuộc giáo xứ: {{ $gx_gp_cha->ten_giao_xu }} Giáo phận: {{ $gx_gp_cha->giaoPhan->ten_giao_phan }}</p>
                        @else
                            <p>Thuộc giáo xứ:   <span style="padding-left: 123px">Giáo phận:  </span></p>
                        @endif
                    ...
                    <h4 style="margin-top: -10px">3. Thông tin hôn phối</h4>
                    <div class="mt--3">
                ...
                <div class="page-break"></div>
                    ...
                    <h4 class="module">1. Thông tin</h4>
                    <div class="mt--3">
                        <p>Tên thánh, họ, gọi: {{ $thanh_vien_me->ten_thanh . ' ' . $thanh_vien_me->ho_va_ten }}</p>
                        ...
                        @endforeach
                        @if($gx_gp_me)
                        <p>Thuộc giáo xứ: {{ $gx_gp_me->ten_giao_xu }} Giáo phận: {{ $gx_gp_me->giaoPhan->ten_giao_phan }}</p>
                            @else
                        <p>Thuộc giáo xứ:  Giáo phận:</p>
                        @endif
                    ...
                    @foreach($thanh_vien_me_bt as $bt)
                        @if($bt->ten_bi_tich == 'Hôn phối')
                        <h4 class="title fs-22">Ngày: {{ \Carbon\Carbon::parse($bt->ngay_dien_ra)->format('d-m-Y') }}  tại {{ $bt->noi_dien_ra }}</h4>
                        <h4 style="margin-top: -10px">3. Thông tin hôn phối</h4>
                        <div class="mt--3" >
            ...
            @endif
                    ...
                    @foreach($thanh_vien_con as $tv)
                      @if($newModal !== $tv->ten_thanh_vien || $count == 0)
                            ...
                            <h4 class="module">1. Thông tin</h4>
                            <p>Tên thánh, họ, gọi: {{ $tv->ten_thanh_thanh_vien . ' '. $tv->ten_thanh_vien }}</p>
