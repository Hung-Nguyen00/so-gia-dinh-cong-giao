        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Thêm nhà dòng</h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="store">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="ten_nha_dong" class="form-control" placeholder="Nhập tên dòng">
                        ...
                        <div class="form-group">
                            <label >Địa chỉ</label>
                            <input type="text" wire:model="dia_chi" class="form-control" placeholder="Nhập địa chỉ dòng">
