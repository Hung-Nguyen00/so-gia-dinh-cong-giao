        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Thêm mới giáo hạt </h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="store">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select select form-control mb-3" data-live-search="true" name="giao_phan_id" wire:model="giao_phan_id">
