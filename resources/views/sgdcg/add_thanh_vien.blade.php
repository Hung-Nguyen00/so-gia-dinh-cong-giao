                                    ...
                                    <div  class="card-body">
                                        <form action="{{ route('so-gia-dinh.storeTV', $sgdcg->id ) }}" method="post" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label class="form-label" style="margin-bottom: 7px;">Họ và tên</label>
                                                ...
                                                <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control"
                                                               value="{{ old('ngay_dien_ra') ?? \Carbon\Carbon::now()->format('Y-m-d') }}" name="ngay_dien_ra">
                                                    </div>
                                                ...
                                                <div class="col-lg-6 mt-2 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               value="{{ old('noi_dien_ra') ?? 'Giáo xứ '. $ten_giao_xu->ten_giao_xu }}" name="noi_dien_ra">
                                                    </div>
